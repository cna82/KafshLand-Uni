...
const ProductsPage = ({ onSetSingleItem, basket, onSetBasket }) => {
  ...
  const handleClick = (data) => {
    onSetSingleItem(data);
    navigate(`/products/${data.id}`);
  };
  const handleAddToBasket = (item) => {
    onSetBasket((prevState) => [...prevState, { ...item, count: 1 }]);
          ...
          {data.length !== 0 ? (
            data.map((item) => {
              ...
              return (
                <>
                  <div
                    className="col-md-3 mb-4 d-flex justify-content-center align-items-center single-item"
                    key={id}
                  ...
                  >
                    <div className="card">
                      <img
                        src={image}
                        className="card-img-top img-fluid prod-image"
                        alt="Product 1"
                      />
                      <div className="card-body">
                        ...
                        >
                          {!basket.find(
                            ...
                            <>
                              <button className="btn btn-danger disabled btn-disabled">
                                {" "}
                                آیتم انتخاب شده است
                              </button>
                            </>
